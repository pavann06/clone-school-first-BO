...
const cardData = [
  { key: 'news_count', label: 'News', bgColor: '#3498db', icon: <NewspaperIcon /> },
  { key: 'survey_count', label: 'Survey', bgColor: '#f1c40f', icon: <AssignmentIcon /> },
  { key: 'poll_count', label: 'Polls', bgColor: '#2ecc71', icon: <PollIcon /> },
  { key: 'feed_count', label: 'Feeds', bgColor: '#9b59b6', icon: <FeedIcon /> },
  { key: 'schools_count', label: 'Schools', bgColor: '#e67e22', icon: <SchoolIcon /> }
];
