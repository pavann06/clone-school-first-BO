...
export const CreateCompetition = async (form_data) => {
  try {
    console.info('FEED-CREATE-FORM-DATA', form_data);

    const resp = await request.post('backoffice/competition', form_data);
...
export const UpdateCompetition = async (form_data) => {
  try {
    console.info('FEED-CREATE-FORM-DATA', form_data);
