...
// import { CreateAppointment, UpdateAppointment } from 'src/api/appointments';

// import { useSnackbar } from 'src/components/snackbar';
// import FormProvider, { RHFUpload, RHFTextField,RHFAutocomplete } from 'src/components/hook-form';
// // ----------------------------------------------------------------------

// export default function AppointmentsNewEditForm({ currentAppointment }) {
...
//     () => ({
//       feature_name: currentAppointment?.feature_name || '',
//       logo: currentAppointment?.logo ? [currentAppointment.logo] : '',
//       description: currentAppointment?.description || '',
//       feature_type: currentAppointment?.feature_type || ''
//     }),
//     [currentAppointment]
//   );
...
//       response = await UpdateAppointment(data);
//     }
//     // if create
//     else{
...
//     //  creation success
//     if (success){
//       enqueueSnackbar(currentAppointment ? 'Update success!' : 'Create success!');
//       // invalidate cache
...
//               >
//                 {!currentAppointment ? 'Create Feature' : 'Save Changes'}
//               </LoadingButton>
//             </Stack>
//           </Card>
//         </Grid>
