...
// export default function SurveysQuestionsNewEditForm({ currentFeed,  surveyId , }) {

//   console.log("Received groupId in FerumFeedsNewEditForm:", surveyId); // Debugging
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      const payload = {
        ...data,
        options:
          data.question_type === 'Yes/No' ? ['Yes', 'No'] : data.options,
      };
