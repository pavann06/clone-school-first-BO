...
export default function OnlineStoreProductsListView() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () =>
      request.get(
        `backoffice/onlinestore/products?page=${pagination.page}&page_size=${pagination.page_size}`
      ),
