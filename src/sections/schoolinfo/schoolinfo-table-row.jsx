...
export default function SchoolInfoTableRow({ row, onEditRow, onDeleteRow }) {
  ...
  // 🟢 FIXED: renamed "title" to avoid shadowing
  const handleOpenDialog = (dialogHeading, content) => {
    setDialogTitle(dialogHeading);
    setDialogContent(content);
    setOpenDialog(true);
  };
  ...
  // 🟢 FIXED: concise arrow body + template string
  const truncateText = (text, length = 80) =>
