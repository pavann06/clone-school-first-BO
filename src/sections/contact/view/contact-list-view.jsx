...
const TABLE_HEAD = [
  ...
  { id: 'address1', label: 'Address', width: 300 },
...
export default function ContactListView() {
  ...
  const handlesubLedger = useCallback(
    (id) => {
      router.push(paths.dashboard.contact.subledger(id));
    },
    [router]
  );
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      <Card>
        <ContactTableToolbar filters={filters} setFilters={setFilters} />
                    ...
                    {tableData &&
                      tableData.map((row, index) => (
                        <ContactTableRow
                          ...
                          subledger={() => handlesubLedger(row.id)}
                        />
                      ))}
                  </>
                )}
