...
//     remarks: Yup.string(),
//     status: Yup.string(),
//     school_id: Yup.array().of(Yup.string()).min(1, 'At least one school is required'),
//   });
...
//       school_id: currentNews?.school_ids || [],
...
//                 name="categories"
//                 label="Categories"
//                 helperText="Separate multiple categories with commas (e.g., Education, Science)"
//               />
...
//                   onChange={(selectedSchools) => setValue('school_id', selectedSchools)}
//                 />
//               </Box>
...
// Updated NewsNewEditForm.jsx with GradesDropdown (multiple) and SchoolsDropdown (single)
