...
import ReturnsNewEditInfo from './returns-new-edit-info';
import ReturnsNewEditOrders from './returns-new-edit-orders';
  ...
  const handleCreateAndSend = handleSubmit(async (data) => {
    try {
      ...
      if (success) {
        ...
        router.push(paths.dashboard.returns.root);
        return response;
      }
