...
import ReturnsAanlytic from '../returns-analytic';
import ReturnsTableRow from '../returns-table-row';
import ReturnsTableToolbar from '../returns-table-toolbar';
...
export default function ReturnsListView() {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: () => request.get('/sales/returns', filters),
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.returns.edit(id));
    },
    [router]
  );
  ...
  const handleViewRow = useCallback(
    (id) => {
      router.push(paths.dashboard.returns.details(id));
    },
    [router]
  );
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      <Card>
        <ReturnsTableToolbar filters={filters} setFilters={setFilters} />
