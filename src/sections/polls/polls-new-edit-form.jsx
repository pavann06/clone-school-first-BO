...
//     () => ({
//       heading: currentPoll?.heading || '',
//       feed_type: currentPoll?.feed_type || '',
//       image: currentPoll?.image || '',
//       video: currentPoll?.video || '',
//       duration: currentPoll?.duration || 0,
//       language: currentPoll?.language || '',
//       description: currentPoll?.description || '',
//       posting_date: currentPoll?.posting_date || '',
...
//         ? await UpdateEdutainment({ ...data, id: currentPoll.id })
...
//               >
//                 {!currentPoll ? 'Create Edutainment' : 'Save Changes'}
//               </LoadingButton>
//             </Stack>
//           </Card>
//         </Grid>
