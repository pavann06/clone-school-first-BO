...
import SalesNewEditGodown from './sales-new-edit-godown';
import SalesNewEditCustomer from './sales-new-edit-customer';
import SalesNewEditDistributor from './sales-new-edit-distributor';
  ...
  return (
    <>
      <Stack
        ...
        sx={{ p: 3 }}
      >
        <SalesNewEditCustomer />
        <SalesNewEditDistributor />
      </Stack>
