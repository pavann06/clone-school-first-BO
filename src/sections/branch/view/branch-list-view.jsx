...
const TABLE_HEAD = [
  ...
  { id: 'branch_name', label: 'Name', width: 250 },
...
export default function BranchListView() {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ['branch', filters],
    queryFn: () => request.get('/clients/branch', filters),
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      <Card>
        <BranchTableToolbar filters={filters} setFilters={setFilters} />
