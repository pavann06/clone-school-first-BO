...
// export default function HospitalsTableToolbar({ filters, setFilters }) {
//   const [searchTerm, setSearchTerm] = useState(filters.display_name);
...
// HospitalsTableToolbar.propTypes = {
