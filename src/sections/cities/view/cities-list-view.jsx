...
import CitiesTableRow from '../cities-table-row';
import CitiesTableToolbar from '../cities-table-toolbar';

const TABLE_HEAD = [
  { id: 'id', label: 'No', width: 100 },
  { id: 'city_name', label: 'City Name', width: 250 },
  { id: 'state', label: 'State', width: 200 },
...
export default function CitiesListView() {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: () => request.get('/cities', filters),
    ...
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <Box sx={{ position: 'relative', mb: { xs: 3, md: 5 } }}>
        ...
        <Button
          ...
          href={paths.dashboard.cities.new}
          variant="contained"
      ...
      <Card>
        <CitiesTableToolbar filters={filters} setFilters={setFilters} />
