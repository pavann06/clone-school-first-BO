...
export default function OnlineCategoriesEditView({ id }) {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      />
      {isLoading ? <LoadingScreen /> : <OnlineCategoriesNewEditForm currentCategory={data?.data} />}
    </Container>
  );
}

OnlineCategoriesEditView.propTypes = {
  id: PropTypes.string,
};
