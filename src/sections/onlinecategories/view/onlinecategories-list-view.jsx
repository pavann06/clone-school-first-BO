...
import OnlineCategoriesTableRow from '../onlinecategories-table-row';
...
export default function OnlineCategoriesListView() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () =>
      request.get(
        `backoffice/onlinestore/categories?page=${pagination.page}&page_size=${pagination.page_size}`
      ),
